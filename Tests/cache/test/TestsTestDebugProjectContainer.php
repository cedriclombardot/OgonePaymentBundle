...
class TestsTestDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), '/media/DATA/Documents/LuckylifeWebAgency/clients/Youcare/symfony2/src/Cedriclombardot/OgonePaymentBundle/Tests/cache/test/annotations', true);
    }
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, '/media/DATA/Documents/LuckylifeWebAgency/clients/Youcare/symfony2/src/Cedriclombardot/OgonePaymentBundle/Tests/Resources');
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), '/media/DATA/Documents/LuckylifeWebAgency/clients/Youcare/symfony2/src/Cedriclombardot/OgonePaymentBundle/Tests/Resources');
    }
    ...
    {
        return $this->services['form.factory'] = new \Symfony\Component\Form\FormFactory(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension($this, array('field' => 'form.type.field', 'form' => 'form.type.form', 'birthday' => 'form.type.birthday', 'checkbox' => 'form.type.checkbox', 'choice' => 'form.type.choice', 'collection' => 'form.type.collection', 'country' => 'form.type.country', 'date' => 'form.type.date', 'datetime' => 'form.type.datetime', 'email' => 'form.type.email', 'file' => 'form.type.file', 'hidden' => 'form.type.hidden', 'integer' => 'form.type.integer', 'language' => 'form.type.language', 'locale' => 'form.type.locale', 'money' => 'form.type.money', 'number' => 'form.type.number', 'password' => 'form.type.password', 'percent' => 'form.type.percent', 'radio' => 'form.type.radio', 'repeated' => 'form.type.repeated', 'search' => 'form.type.search', 'textarea' => 'form.type.textarea', 'text' => 'form.type.text', 'time' => 'form.type.time', 'timezone' => 'form.type.timezone', 'url' => 'form.type.url', 'model' => 'propel.form.type.model'), array('form' => array(0 => 'form.type_extension.field', 1 => 'form.type_extension.csrf')), array(0 => 'form.type_guesser.validator', 1 => 'form.type_guesser.propel'))));
    }
    ...
    {
        return $this->services['form.type_extension.field'] = new \Symfony\Component\Form\Extension\Validator\Type\FormTypeValidatorExtension($this->get('validator'));
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return Cedriclombardot\OgonePaymentBundle\Config\ConfigurationContainer A Cedriclombardot\OgonePaymentBundle\Config\ConfigurationContainer instance.
     */
    protected function getOgone_ConfigurationService()
    {
        return $this->services['ogone.configuration'] = new \Cedriclombardot\OgonePaymentBundle\Config\ConfigurationContainer(array('PSPID' => 'MyCompagny', 'currency' => 'EUR', 'language' => 'fr_FR', 'title' => 'MyCompagny', 'bgColor' => '#4e84c4', 'txtColor' => '#FFFFFF', 'tblBgColor' => '#FFFFFF', 'buttonBgColor' => '#00467F', 'buttonTxtColor' => '#FFFFFF', 'fontType' => 'Verdana'));
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return Cedriclombardot\OgonePaymentBundle\Feedback\TransactionFeedbacker A Cedriclombardot\OgonePaymentBundle\Feedback\TransactionFeedbacker instance.
     */
    protected function getOgone_FeedbackerService()
    {
        ...
        return $this->services['ogone.feedbacker'] = $this->scopedServices['request']['ogone.feedbacker'] = new \Cedriclombardot\OgonePaymentBundle\Feedback\TransactionFeedbacker($this->get('request'), $this->get('ogone.secure_configuration'));
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return Cedriclombardot\OgonePaymentBundle\Builder\TransactionBuilder A Cedriclombardot\OgonePaymentBundle\Builder\TransactionBuilder instance.
     */
    protected function getOgone_TransactionBuilderService()
    {
        return $this->services['ogone.transaction_builder'] = new \Cedriclombardot\OgonePaymentBundle\Builder\TransactionBuilder(new \Cedriclombardot\OgonePaymentBundle\Builder\TransactionFormBuilder($this->get('form.factory'), $this->get('ogone.secure_configuration')), $this->get('ogone.configuration'));
    }
    ...
    {
        return $this->services['propel.configuration'] = new \PropelConfiguration();
    }
    ...
    {
        return $this->services['propel.logger'] = new \Symfony\Bridge\Propel1\Logger\PropelLogger(NULL, $this->get('debug.stopwatch'));
    }
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, '/media/DATA/Documents/LuckylifeWebAgency/clients/Youcare/symfony2/src/Cedriclombardot/OgonePaymentBundle/Tests/config/routing.yml', array('cache_dir' => '/media/DATA/Documents/LuckylifeWebAgency/clients/Youcare/symfony2/src/Cedriclombardot/OgonePaymentBundle/Tests/cache/test', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'TeststestUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'TeststestUrlMatcher'), new \Symfony\Component\Routing\RequestContext('', 'GET', 'localhost', 'http', 80, 443));
    }
    ...
    {
        return $this->services['router_listener'] = new \Symfony\Component\HttpKernel\EventListener\RouterListener($this->get('router'), NULL);
    }
    ...
    {
        return $this->services['session.handler'] = new \Symfony\Component\HttpFoundation\Session\Storage\Handler\NativeFileSessionHandler('/media/DATA/Documents/LuckylifeWebAgency/clients/Youcare/symfony2/src/Cedriclombardot/OgonePaymentBundle/Tests/cache/test/sessions');
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('/media/DATA/Documents/LuckylifeWebAgency/clients/Youcare/symfony2/src/Cedriclombardot/OgonePaymentBundle/Tests/cache/test/sessions');
    }
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, '/media/DATA/Documents/LuckylifeWebAgency/clients/Youcare/symfony2/src/Cedriclombardot/OgonePaymentBundle/Tests', 'UTF-8');
    }
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini')), array('cache_dir' => '/media/DATA/Documents/LuckylifeWebAgency/clients/Youcare/symfony2/src/Cedriclombardot/OgonePaymentBundle/Tests/cache/test/translations', 'debug' => true));
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('/media/DATA/Documents/LuckylifeWebAgency/clients/Youcare/symfony2/src/Cedriclombardot/OgonePaymentBundle/vendor/symfony/symfony/src/Symfony/Bridge/Twig/Resources/views/Form');
     ...
     * make it public, otherwise you might end up with broken code.
     *
     * @return Cedriclombardot\OgonePaymentBundle\Config\SecureConfigurationContainer A Cedriclombardot\OgonePaymentBundle\Config\SecureConfigurationContainer instance.
     */
    protected function getOgone_SecureConfigurationService()
    {
        return $this->services['ogone.secure_configuration'] = new \Cedriclombardot\OgonePaymentBundle\Config\SecureConfigurationContainer(array('shaInKey' => 'Mysecretsig1875!?', 'shaOutKey' => 'Mysecretsig1875!?', 'algorithm' => 'sha512'));
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/media/DATA/Documents/LuckylifeWebAgency/clients/Youcare/symfony2/src/Cedriclombardot/OgonePaymentBundle/Tests/cache/test');
    }
    ...
    {
        return $this->services['validator.mapping.class_metadata_factory'] = new \Symfony\Component\Validator\Mapping\ClassMetadataFactory(new \Symfony\Component\Validator\Mapping\Loader\LoaderChain(array(0 => new \Symfony\Component\Validator\Mapping\Loader\AnnotationLoader($this->get('annotation_reader')), 1 => new \Symfony\Component\Validator\Mapping\Loader\StaticMethodLoader(), 2 => new \Symfony\Component\Validator\Mapping\Loader\XmlFilesLoader(array(0 => '/media/DATA/Documents/LuckylifeWebAgency/clients/Youcare/symfony2/src/Cedriclombardot/OgonePaymentBundle/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/config/validation.xml')), 3 => new \Symfony\Component\Validator\Mapping\Loader\YamlFilesLoader(array()))), NULL);
    }
    ...
    {
        return array(
            'kernel.root_dir' => '/media/DATA/Documents/LuckylifeWebAgency/clients/Youcare/symfony2/src/Cedriclombardot/OgonePaymentBundle/Tests',
            'kernel.environment' => 'test',
            'kernel.debug' => true,
            'kernel.name' => 'Tests',
            'kernel.cache_dir' => '/media/DATA/Documents/LuckylifeWebAgency/clients/Youcare/symfony2/src/Cedriclombardot/OgonePaymentBundle/Tests/cache/test',
            'kernel.logs_dir' => '/media/DATA/Documents/LuckylifeWebAgency/clients/Youcare/symfony2/src/Cedriclombardot/OgonePaymentBundle/Tests/logs',
            'kernel.bundles' => array(
                'FrameworkBundle' => 'Symfony\\Bundle\\FrameworkBundle\\FrameworkBundle',
                'TwigBundle' => 'Symfony\\Bundle\\TwigBundle\\TwigBundle',
                'PropelBundle' => 'Propel\\PropelBundle\\PropelBundle',
                'CedriclombardotOgonePaymentBundle' => 'Cedriclombardot\\OgonePaymentBundle\\CedriclombardotOgonePaymentBundle',
            ),
            ...
            'debug.container.dump' => '/media/DATA/Documents/LuckylifeWebAgency/clients/Youcare/symfony2/src/Cedriclombardot/OgonePaymentBundle/Tests/cache/test/TestsTestDebugProjectContainer.xml',
            ...
            'session.save_path' => '/media/DATA/Documents/LuckylifeWebAgency/clients/Youcare/symfony2/src/Cedriclombardot/OgonePaymentBundle/Tests/cache/test/sessions',
            ...
            'validator.mapping.loader.xml_files_loader.mapping_files' => array(
                0 => '/media/DATA/Documents/LuckylifeWebAgency/clients/Youcare/symfony2/src/Cedriclombardot/OgonePaymentBundle/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/config/validation.xml',
            ),
            ...
            'router.resource' => '/media/DATA/Documents/LuckylifeWebAgency/clients/Youcare/symfony2/src/Cedriclombardot/OgonePaymentBundle/Tests/config/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => '/media/DATA/Documents/LuckylifeWebAgency/clients/Youcare/symfony2/src/Cedriclombardot/OgonePaymentBundle/Tests/cache/test/twig',
                'charset' => 'UTF-8',
                'debug' => true,
            ),
            'debug.templating.engine.twig.class' => 'Symfony\\Bundle\\TwigBundle\\Debug\\TimedTwigEngine',
            'propel.path' => '/media/DATA/Documents/LuckylifeWebAgency/clients/Youcare/symfony2/src/Cedriclombardot/OgonePaymentBundle/Tests/../vendor/propel/propel1',
            'propel.phing_path' => '/media/DATA/Documents/LuckylifeWebAgency/clients/Youcare/symfony2/src/Cedriclombardot/OgonePaymentBundle/Tests/../vendor/phing/phing/classes',
            'propel.logging' => true,
            ...
            'ogone.configuration.class' => 'Cedriclombardot\\OgonePaymentBundle\\Config\\ConfigurationContainer',
            'ogone.secure_configuration.class' => 'Cedriclombardot\\OgonePaymentBundle\\Config\\SecureConfigurationContainer',
